  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (isCacheExist) {
        ...
        //if people watch course or visit it everyday or within 7 days then it doesn't expire else it expires after 7 days
...
export const addQuestion = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      console.log(
        "🚀 ~ file: course.controller.ts:176 ~ courseContent:",
        courseContent
      );
...
export const addAnswer = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      console.log(
        "🚀 ~ file: course.controller.ts:234 ~ courseContent:",
        courseContent
      );
